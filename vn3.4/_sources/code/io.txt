...
``variable_metadata.inc``
    ...
    Variable type
        ...
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_PFT``     | Single levels dimension of size :nml:mem:`JULES_MODEL_LEVELS::npft`                                 |
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_NVG``     | Single levels dimension of size :nml:mem:`JULES_MODEL_LEVELS::nnvg`                                 |
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_TYPE``    | Single levels dimension of size ``ntype`` (:nml:mem:`JULES_MODEL_LEVELS::npft` +                    |
        |                      | :nml:mem:`JULES_MODEL_LEVELS::nnvg`)                                                                |
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_TILE``    | Single levels dimension of size ``ntiles`` (1 if :nml:mem:`JULES_SWITCHES::l_aggregate` = TRUE,     |
        |                      | ``ntype`` otherwise)                                                                                |
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_SOIL``    | Single levels dimension of size :nml:mem:`JULES_MODEL_LEVELS::sm_levels`                            |
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_SCPOOL``  | Single levels dimension of size ``dim_cs1`` (number of soil carbon pools, i.e. 4 if                 |
        |                      | :nml:mem:`JULES_SWITCHES::l_triffid` = TRUE, 1 otherwise)                                           |
        +----------------------+-----------------------------------------------------------------------------------------------------+
        | ``VAR_TYPE_SNOW``    | Two levels dimensions: the first of size ``ntiles`` and the second of size                          |
        |                      | :nml:mem:`JULES_MODEL_LEVELS::nsmax`                                                                |
        +----------------------+-----------------------------------------------------------------------------------------------------+
