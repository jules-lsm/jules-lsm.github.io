...
* A `CF convention coordinates attribute <http://cf-pcmdi.llnl.gov/documents/cf-conventions/1.0/cf-conventions.html#id2888361>`_ has been added to all output variables that explicitly links the latitude and longitude to the data.
