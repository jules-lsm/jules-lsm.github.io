...
These variables have one value for each plant functional type (see :doc:`/overview`). For each variable, the values for each pft are in consecutive columns. Each row is one timestep of data.
